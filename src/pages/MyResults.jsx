...
export default function MyResults({ showToast }) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-600 mb-6">Review your recent laboratory results securely. All data is encrypted and confidential.</p>
          ...
          {(filtered.length ? filtered : [
            ...
            <div key={i} className="border rounded-xl p-4">
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <span className={`text-xs px-2 py-1 rounded-full ${statusColor(b.status)}`}>{b.status || 'Pending'}</span>
                  <h3 className="font-bold mt-2">{Array.isArray(b.tests) ? b.tests.join(', ') : b.tests}</h3>
