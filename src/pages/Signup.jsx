      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-4xl grid md:grid-cols-2">
        <div className="p-8">
          <div className="flex items-center gap-2 mb-6">
            <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-white font-bold">HL</div>
            <span className="font-bold text-xl text-dark">HomeLab GH</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input name="fullName" value={form.fullName} onChange={handleChange} placeholder="Enter your full name" className="w-full pl-10 pr-4 py-2.5 border rounded-lg" required />
              </div>
            </div>
            <div>
              <label className="text-sm font-medium">Phone Number</label>
              <div className="relative mt-1 flex">
                <span className="inline-flex items-center px-3 border border-r-0 rounded-l-lg bg-gray-50 text-sm">🇬🇭 +233</span>
                <input name="phone" value={form.phone} onChange={handleChange} placeholder="20 000 0000" className="flex-1 px-3 py-2.5 border rounded-r-lg" required />
              </div>
            </div>
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input name="email" type="email" value={form.email} onChange={handleChange} placeholder="you@example.com" className="w-full pl-10 pr-4 py-2.5 border rounded-lg" required />
              </div>
            </div>
            <div>
              ...
              <div className="relative mt-1">
                ...
                <input name="password" type={showPass ? 'text' : 'password'} value={form.password} onChange={handleChange} placeholder="••••••••" className="w-full pl-10 pr-10 py-2.5 border rounded-lg" required />
            ...
            <div>
              ...
              <div className="relative mt-1">
                ...
                <select name="location" value={form.location} onChange={handleChange} className="w-full pl-10 pr-4 py-2.5 border rounded-lg appearance-none">
                  <option>Accra</option>
                  <option>Tema</option>
            ...
            <button type="submit" className="w-full bg-primary text-white py-3 rounded-lg font-medium hover:bg-blue-600">
              Create Account
            </button>
          </form>
