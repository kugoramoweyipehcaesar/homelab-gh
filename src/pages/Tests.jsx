...
export default function Tests({ showToast, updateCartCount }) {
  ...
  useEffect(() => {
    ...
    setCart(savedCart)
    const savedPrices = JSON.parse(localStorage.getItem('testPrices') || '{}')
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-bold text-dark">Lab Test Menu</h1>
        ...
        <div className="bg-teal text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2">
          <span>🛡️</span> Ghana Health Service • Certified
        </div>
      </div>
